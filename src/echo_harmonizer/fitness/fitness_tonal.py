...
from echo_harmonizer.chord_pool.chord_roles import get_role_masks_for_key, get_role_mask_table, bit
from echo_harmonizer.fitness.role_to_function import best_transition_score, mask_has_function
...
class FitnessEvaluatorTonal(FitnessPrimaryBase):
    ...
    NOTE:
      - sus ?œresolution??is handled inside role_to_function as a special transition rule,
