...
from echo_harmonizer.chord_pool.chords_master import MASTER_CHORD_TABLE, MASTER_CHORD_REGISTRY
from echo_harmonizer.chord_pool.chord_roles import get_role_masks_for_key, allowed_mask_from_groups, get_role_mask_table, bit
from echo_harmonizer.config import ChordPolicyConfig, Density, KeySpec
from echo_harmonizer.chord_pool.pool_policy import effective_enabled_groups
...
if __name__ == "__main__":
    ...
    from echo_harmonizer.melody.preprocess_melody import Melody
    from echo_harmonizer.config import ChordPolicyConfig, KeySpec
